...
\hlcom{## ---- fVSmTimeAB ----}
\hlstd{def.par} \hlkwb{<-} \hlkwd{par}\hlstd{(}\hlkwc{no.readonly} \hlstd{=} \hlnum{TRUE}\hlstd{)}
\hlkwd{layout}\hlstd{(}\hlkwd{matrix}\hlstd{(}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{0}\hlstd{,}\hlnum{0}\hlstd{,}\hlnum{2}\hlstd{,}\hlnum{4}\hlstd{),} \hlnum{2}\hlstd{,} \hlnum{3}\hlstd{),} \hlkwc{respect} \hlstd{=} \hlnum{TRUE}\hlstd{,}
       \hlkwc{widths}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{7.5}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{7.5}\hlstd{),} \hlkwc{heights}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{7.15}\hlstd{,}\hlnum{2}\hlstd{))}
...
\hlkwd{par}\hlstd{(}\hlkwc{mar}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{0.2}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{2}\hlstd{,}\hlnum{0}\hlstd{),} \hlkwc{bty}\hlstd{=}\hlstr{"o"}\hlstd{,} \hlkwc{cex.axis}\hlstd{=}\hlnum{1.1}\hlstd{)}
\hlkwd{plot}\hlstd{(timef}\hlopt{~}\hlstd{time,} \hlkwc{data}\hlstd{=DAAG}\hlopt{::}\hlstd{nihills,} \hlkwc{xlim}\hlstd{=xlim,} \hlkwc{xaxt}\hlstd{=}\hlstr{'n'}\hlstd{,}
     \hlkwc{ylab}\hlstd{=}\hlstr{""}\hlstd{,} \hlkwc{fg}\hlstd{=}\hlstr{"gray"}\hlstd{,} \hlkwc{main}\hlstd{=}\hlstr{" "}\hlstd{)}
\hlkwd{abline}\hlstd{(}\hlkwd{lm}\hlstd{(timef}\hlopt{~}\hlstd{time,} \hlkwc{data}\hlstd{=DAAG}\hlopt{::}\hlstd{nihills),} \hlkwc{col}\hlstd{=}\hlnum{2}\hlstd{)}
\hlkwd{mtext}\hlstd{(}\hlkwc{side}\hlstd{=}\hlnum{2}\hlstd{,}\hlkwc{line}\hlstd{=}\hlnum{2.25}\hlstd{,}\hlstr{"Female times"}\hlstd{,} \hlkwc{las}\hlstd{=}\hlnum{0}\hlstd{)}
...
\hlkwd{plot}\hlstd{(timef}\hlopt{~}\hlstd{time,} \hlkwc{data}\hlstd{=DAAG}\hlopt{::}\hlstd{nihills,} \hlkwc{xlim}\hlstd{=xlim,} \hlkwc{xaxt}\hlstd{=}\hlstr{'n'}\hlstd{,}
     \hlkwc{log}\hlstd{=}\hlstr{'xy'}\hlstd{,} \hlkwc{fg}\hlstd{=}\hlstr{"gray"}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{""}\hlstd{,} \hlkwc{main}\hlstd{=}\hlstr{" "}\hlstd{)}
\hlkwd{abline}\hlstd{(}\hlkwd{lm}\hlstd{(}\hlkwd{log10}\hlstd{(timef)}\hlopt{~}\hlkwd{log10}\hlstd{(time),} \hlkwc{data}\hlstd{=DAAG}\hlopt{::}\hlstd{nihills),} \hlkwc{col}\hlstd{=}\hlnum{2}\hlstd{)}
\hlkwd{mtext}\hlstd{(}\hlkwc{side}\hlstd{=}\hlnum{2}\hlstd{,}\hlkwc{line}\hlstd{=}\hlnum{2.25}\hlstd{,}\hlstr{"Female times (log scale)"}\hlstd{,} \hlkwc{las}\hlstd{=}\hlnum{0}\hlstd{)}
...
\hlkwd{par}\hlstd{(}\hlkwc{mar}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{,}\hlnum{2.75}\hlstd{,}\hlnum{0}\hlstd{,}\hlnum{0}\hlstd{),} \hlkwc{bty}\hlstd{=}\hlstr{"n"}\hlstd{)}
...
\hlkwd{print}\hlstd{(}\hlstr{"Run the separate functions fig8.4A() and fig8.4B()"}\hlstd{)}
\hlstd{\}}
\hlstd{fig8.4A} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## Panel A}
...
\hlstd{\}}
\hlstd{fig8.4B} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## Panel B}
...
\hlkwd{print}\hlstd{(}\hlstr{"Run the separate functions fig8.11A() and fig8.11B()"}\hlstd{)}
\hlstd{\}}
\hlstd{fig8.9A} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- scatter-ni ----}
\hlcom{## Unlogged data}
...
\hlstd{\}}
\hlstd{fig8.9B} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- scatter-logni ----}
...
\hlkwd{print}\hlstd{(}\hlstr{"Run the separate functions fig8.17A() and fig8.17B()"}\hlstd{)}
\hlstd{\}}
\hlstd{fig8.15A} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- bronchitA ----}
\hlcom{## ---- bronchit-ylim ----}
...
\hlstd{\}}
\hlstd{fig8.15B} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- bronchitB ----}
\hlcom{## ---- bronchit-ylim ----}
\hlstd{ylim} \hlkwb{<-} \hlkwd{range}\hlstd{(bronchit}\hlopt{$}\hlstd{poll)}\hlopt{+}\hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{2.5}\hlstd{)}
\hlcom{## Panel B}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{figset8} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwa{if}\hlstd{(check4Elec)}\hlkwd{fig8.12}\hlstd{()}
\end{alltt}
\end{kframe}
\end{knitrout}
}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwa{if}\hlstd{(check4Elec)}\hlkwd{fig8.13}\hlstd{()}
\end{alltt}
\end{kframe}
\end{knitrout}
