...
\begin{figure}[H]
<<fVSmTime-8_3, fig.width=2.75, fig.height=3, out.width="0.45\\textwidth", eval=doFigs>>=
fig8.3()
@ %
...
\begin{figure}[H]
<<mVSfTime-8_5, fig.width=3.0, fig.height=3.0, out.width="0.47\\textwidth", eval=doFigs>>=
fig8.5A()
fig8.5B()
@ %
...
\begin{figure}[H]
<<fig8_6e, echo=FALSE, fig.width=3, fig.height=3, out.width="0.47\\textwidth", eval=doFigs>>=
fig8.6A()
fig8.6B()
@ %
...
\begin{figure}[H]
<<diag-mf-8_7, fig.width=3, fig.height=3, out.width="0.23\\textwidth", eval=doFigs>>=
fig8.7()
@ %
...
\begin{figure}[H]
<<diag-logmf-8_8, fig.width=3, fig.height=3, out.width="0.23\\textwidth", eval=doFigs>>=
fig8.8()
@ %
\caption{Diagnostic plots from the regession of \txtt{log(timef)} on
...
\begin{figure}[H]
<<simscat-8_9, fig.width=7, fig.height=3, out.width="0.97\\textwidth", eval=doFigs>>=
fig8.9()
@ %
...
\begin{figure}[H]
<<tomato-8-10e, fig.width=2.75, fig.height=2.75, out.width="0.47\\textwidth", eval=doFigs>>=
fig8.10A()
fig8.10B()
@ %
...
\begin{figure}[H]
<<splot2-ni-8-11e, fig.width=5.25, fig.height=5.25, out.width="0.48\\textwidth", eval=doFigs>>=
fig8.11A()
fig8.11B()
@ %
...
\begin{figure}[H]
<<tplot-ni-8_12, fig.width=3, fig.height=3,bot=0.5, left=1, out.width="0.48\\textwidth", eval=doFigs>>=
fig8.12()
@ %
...
\begin{figure}[H]
<<bsnVary-8_13, fig.width=4, fig.height=3.5, warning=FALSE, message=FALSE, eval=doFigs>>=
...
<<Elec-spm-8_14, fig.width=8, fig.height=8, out.width="0.775\\textwidth", eval=doFigs>>=
...
\begin{figure}[H]
<<spm-cost-q-8_15, fig.width=6.5, fig.height=6.5, out.width="0.45\\textwidth", eval=doFigs>>=
...
\begin{figure}[H]
<<elec-me-tplot-8_16, fig.width=3, fig.height=3, out.width="0.24\\textwidth", eval=doFigs, eval=doFigs>>=
...
\begin{figure}[H]
<<cig2-tplot-8_18, fig.width=3.25, fig.height=3.25, out.width="0.47\\textwidth", eval=doFigs>>=
fig8.18()
@ %
