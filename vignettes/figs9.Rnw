...
<<fig9_16, eval=TRUE>>=
fig9.16 <- function(){
print(c("The Figure 9.16 screen display was obtained using the playwith GUI.",
...
ggplot2::quickplot(Year, mdbRain, data=DAAG::bomregions2011,
...
ggplot2::quickplot(Year, mdbRain, data=DAAG::bomregions2012,
...
\begin{figure}[ht]
<<fig9_1e, fig.width=4, fig.height=4.25, top=2, rt=2, crop=TRUE, out.width="0.47\\textwidth">>=
fig9.1()
@ %
...
\begin{suppfigure}[ht]
<<supp9_1e, fig.width=7.5, fig.height=7, cache=FALSE, crop=TRUE, out.width="0.75\\textwidth">>=
supp9.1()
@ %
...
\begin{figure}[ht]
<<fig9_2e, dev='png', fig.width=2.5, fig.height=2.75, top=2, out.width="0.32\\textwidth">>=
fig9.2()
@ %
...
\begin{figure}[ht]
<<fig9_3e, fig.width=8, fig.height=2.4, top=1, out.width="0.9\\textwidth">>=
...
\begin{suppfigure}[ht]
<<supp9_2e, fig.width=5, fig.height=5, out.width="0.8\\textwidth">>=
supp9.2()
@ %
...
\begin{figure}[ht]
<<fig9_4e, eval=TRUE, fig.width=3.25, fig.height=3.25, left=1, rt=1, bot=2, top=2, out.width="0.47\\textwidth">>=
fig9.4()
@ %
...
\begin{suppfigure}
<<supp9_3e, out.width="0.47\\textwidth">>=
supp9.3()
@ %
...
\begin{figure}[ht]
<<fig9_5e, eval=TRUE, fig.width=3.5, fig.height=2.5, bot=1, out.width="0.42\\textwidth">>=
fig9.5()
@ %
\vspace*{-18pt}
...
\begin{figure}[ht]
<<fig9_6e, fig.width=4, fig.height=4, top=1, bot=1, rt=1, out.width="0.24\\textwidth">>=
fig9.6()
@ %
\vspace*{-12pt}
...
\begin{figure}[ht]
\vspace*{-6pt}
<<fig9_7e, eval=TRUE, fig.width=3.5, fig.height=3.5, out.width="0.47\\textwidth">>=
fig9.7()
@ %
...
\begin{figure}[ht]
<<fig9_8e, fig.width=3.5, fig.height=3.5, out.width="0.47\\textwidth">>=
fig9.8()
@ %
...
\begin{figure}[ht]
<<fig9_9e, fig.width=6, fig.height=3.5, out.width="0.8\\textwidth">>=
fig9.9()
@ %
...
\begin{figure}[ht]
<<fig9_10e, fig.width=6, fig.height=3.25, out.width="0.8\\textwidth">>=
fig9.10()
@ %
...
\begin{figure}[ht]
<<fig9_11e, fig.width=3.5, fig.height=2.5, out.width="0.47\\textwidth", cache=FALSE>>=
fig9.11()
@ %
...
\begin{figure}[ht]
<<fig9_12e, fig.width=8.5, fig.height=4, out.width="0.97\\textwidth">>=
fig9.12()
@ %
...
\begin{figure}[ht]
<<fig9_13e-strip-bw, fig.width=3.5, fig.height=2.5, cache=FALSE, out.width="0.47\\textwidth">>=
<<strip-bw>>
@ %
...
\begin{figure}[ht]
<<fig9_14e, fig.width=6, fig.height=3.15, out.width="0.8\\textwidth">>=
fig9.14()
@ %
...
\begin{figure}[ht]
<<fig9_15e, fig.width=3.5, fig.height=3.5, out.width="0.47\\textwidth">>=
fig9.15()
@ %
...
\begin{figure}[ht]
<<fig9_17e, fig.width=5.5, fig.height=3.25, out.width="0.8\\textwidth", warning=FALSE>>=
fig9.17()
@ %
...
\begin{figure}[ht]
<<fig9_18e, fig.width=6, fig.height=3.25, out.width="0.8\\textwidth", warning=FALSE>>=
fig9.18()
@ %
...
\begin{suppfigure}
<<supp9_4e, fig.width=5.5, fig.height=3.25, out.width="0.8\\textwidth", warning=FALSE>>=
supp9.4()
@ %
\caption{Annual rainfall, from 1901 to 2012, for the Murray-Darling
...
\begin{figure}[ht]
<<fig9_19e, fig.width=4.5, fig.height=3.5, out.width="0.8\\textwidth">>=
fig9.19()
@ %
