...
opts_chunk$set(fig.path='figs/xmeth-', cache.path='cache/xmeth-',
...
fig9.2 <- function(){
print("Run the separate figures fig9.2A() and fig9.2B()")
}
@ %
\end{figure}
...
fig9.5 <- function(){
"Run the separate functions fig9.5A() and fig9.5B()."
}
@ %
...
\begin{figure}
<<smooth-ohms-12_1, echo=FALSE, fig.width=4.5, fig.height=3.5, out.width="0.65\\textwidth">>=
fig9.1()
@ %
...
\begin{figure}
<<plotVIS-12_2, echo=FALSE, fig.width=8.5, fig.height=3.5, out.width="0.97\\textwidth">>=
...
\begin{figure}
<<ant111b-12_3, echo=FALSE, fig.width=4.5, fig.height=3.5, out.width="0.65\\textwidth">>=
fig9.3()
@ %
...
\begin{figure}
<<Erie1-12_4, echo=FALSE, fig.width=5.5, fig.height=2.5, out.width="0.8\\textwidth">>=
fig9.4()
@ %
...
\begin{figure}
<<lagErie-12_5, echo=FALSE, fig.width=6, fig.height=2.75, out.width="0.98\\textwidth">>=
fig9.5A()
@ %
\vspace*{-3pt}

<<acfErie, echo=FALSE, fig.width=5.4, fig.height=2.5, out.width="0.7\\textwidth">>=
...
\begin{figure}
<<gamErie-12_6, echo=FALSE, fig.width=6.5, fig.height=3.25, out.width="0.75\\textwidth">>=
fig9.6()
@ %
...
\begin{figure}
<<arima-sim-12_7, fig.width=3.15, fig.height=3.35, echo=FALSE, out.width="0.32\\textwidth">>=
fig9.7()
@ %
...
\begin{figure}
<<Erie-fcast-12_8, echo=FALSE, fig.width=5.5, fig.height=2.5, out.width="0.8\\textwidth", warning=FALSE, message=FALSE>>=
fig9.8()
@ %
...
\begin{figure}
<<mdb-gam-12_9, echo=FALSE, warning=FALSE, fig.width=4.5, fig.height=3.0, out.width="0.47\\textwidth">>=
fig9.9()
@ %
...
\begin{figure}
<<ar1sims-12_10, echo=FALSE, warning=FALSE, fig.width=3, left=1, fig.height=2.0, out.width="0.32\\textwidth">>=
fig9.10()
@ %
...
\begin{figure*}[h]
<<au-both-12_11, echo=FALSE, fig.width=4.25, fig.height=3.75, top=2, out.width="0.47\\textwidth">>=
fig9.11A()
fig9.11B()
@ %
...
\begin{figure}
<<fgl-scores2D-12_12, echo=FALSE, fig.width=5, fig.height=3.75, out.width="0.65\\textwidth">>=
## ---- fgl-lda ----
...
\begin{figure}
<<treefig-12_13, echo=FALSE, fig.width=3.5, fig.height=4, out.width="0.55\\textwidth">>=
fig9.13()
@ %
...
\begin{figure}
<<rf-x-bronchit, echo=FALSE, fig.width=2, fig.height=1.75, out.width="0.24\\textwidth">>=
fig9.14()
@ %
...
\begin{figure}
<<proximity-plot, echo=FALSE, w=3.5, h=3.65, out.width="0.47\\textwidth">>=
fig9.15()
@ %
...
\begin{figure}
<<aupoints_12_16, echo=FALSE, fig.width=5.25, fig.height=4.5, rt=3, out.width="0.6\\textwidth">>=
fig9.16()
@ %
...
\begin{figure*}[h]
<<au-both-12_17, echo=FALSE, fig.width=5.25, fig.height=4.5, top=2, out.width="0.47\\textwidth">>=
fig9.17A()
fig9.17B()
@ %
