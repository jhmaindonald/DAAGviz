...
\begin{figure}
<<smooth-ohms-9_1, echo=FALSE, fig.width=4.5, fig.height=3.5, out.width="0.65\\textwidth", eval=doFigs>>=
fig9.1()
@ %
...
\begin{figure}
<<plotVIS-9_2, echo=FALSE, fig.width=8.5, fig.height=3.5, out.width="0.97\\textwidth", eval=doFigs>>=
...
\begin{figure}
<<ant111b-9_3, echo=FALSE, fig.width=4.5, fig.height=3.5, out.width="0.65\\textwidth", eval=doFigs>>=
fig9.3()
@ %
...
\begin{figure}
<<Erie1-9_4, echo=FALSE, fig.width=5.5, fig.height=2.5, out.width="0.8\\textwidth", eval=doFigs>>=
fig9.4()
@ %
...
\begin{figure}
<<lagErie-9_5, echo=FALSE, fig.width=6, fig.height=2.75, out.width="0.98\\textwidth", eval=doFigs>>=
fig9.5A()
@ %
\vspace*{-3pt}
...
\begin{figure}
<<gamErie-9_6, echo=FALSE, fig.width=6.5, fig.height=3.25, out.width="0.75\\textwidth", eval=doFigs>>=
fig9.6()
@ %
...
\begin{figure}
<<arima-sim-9_7, fig.width=3.15, fig.height=3.35, echo=FALSE, out.width="0.32\\textwidth", eval=doFigs>>=
fig9.7()
@ %
...
\begin{figure}
<<Erie-fcast-9_8, echo=FALSE, fig.width=5.5, fig.height=2.5, out.width="0.8\\textwidth", warning=FALSE, message=FALSE, eval=doFigs>>=
fig9.8()
@ %
...
\begin{figure}
<<mdb-gam-9_9, echo=FALSE, warning=FALSE, fig.width=4.5, fig.height=3.0, out.width="0.47\\textwidth", eval=doFigs>>=
fig9.9()
@ %
...
\begin{figure}
<<ar1sims-9_10, echo=FALSE, warning=FALSE, fig.width=3, left=1, fig.height=2.0, out.width="0.32\\textwidth", eval=doFigs>>=
fig9.10()
@ %
...
\begin{figure*}[h]
<<au-both-9_11, echo=FALSE, fig.width=4.25, fig.height=3.75, top=2, out.width="0.47\\textwidth", eval=doFigs>>=
fig9.11A()
fig9.11B()
@ %
...
\begin{figure}
<<fgl-scores2D-9_12, echo=FALSE, fig.width=5, fig.height=3.75, out.width="0.65\\textwidth", eval=doFigs>>=
## ---- fgl-lda ----
...
\begin{figure}
<<treefig-9_13, echo=FALSE, fig.width=3.5, fig.height=4, out.width="0.55\\textwidth", eval=doFigs>>=
fig9.13()
@ %
...
\begin{figure}
<<aupoints_9_16, echo=FALSE, fig.width=5.25, fig.height=4.5, rt=3, out.width="0.6\\textwidth", eval=doFigs>>=
fig9.16()
@ %
...
\begin{figure*}[h]
<<au-both-9_17, echo=FALSE, fig.width=5.25, fig.height=4.5, top=2, out.width="0.47\\textwidth", eval=doFigs>>=
fig9.17A()
fig9.17B()
@ %
