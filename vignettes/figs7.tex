...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{fig7.2} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- alpha-ex ----}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{fig7.3} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- aspect ----}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{supp7.3} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- fposs-density ----}
\hlcom{## Supplementary figure 7.3}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{fig7.5} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- boxplot ----}
\hlcom{## Code}
\hlkwd{with}\hlstd{(}\hlkwd{subset}\hlstd{(possum, sex}\hlopt{==}\hlstr{"f"}\hlstd{),}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{fig7.6} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- possum-qqn ----}
\hlstd{ftotlen} \hlkwb{<-} \hlkwd{subset}\hlstd{(possum, sex} \hlopt{==} \hlstr{"f"}\hlstd{)[,} \hlstr{"totlngth"}\hlstd{]}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{fig7.7} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- plot-expr ----}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{fig7.8} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- cline-gph ----}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{fig7.9} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- rowSwim ----}
\hlkwd{xyplot}\hlstd{(ht} \hlopt{~} \hlstd{wt} \hlopt{|} \hlstd{sport,} \hlkwc{groups}\hlstd{=sex,} \hlkwc{data}\hlstd{=ais,}
       ...
       \hlkwc{subset}\hlstd{=sport}\hlopt{%in%}\hlkwd{c}\hlstd{(}\hlstr{"Row"}\hlstd{,}\hlstr{"Swim"}\hlstd{))}
\hlstd{\}}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{fig7.12} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- jobs-basic ----}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{fig7.19} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- aisRS ----}
\hlcom{## Extract from ais data for rowers and swimmers}
\hlstd{aisRS} \hlkwb{<-} \hlkwd{subset}\hlstd{(DAAG}\hlopt{::}\hlstd{ais, sport} \hlopt{%in%} \hlkwd{c}\hlstd{(}\hlstr{"Row"}\hlstd{,}\hlstr{"Swim"}\hlstd{))}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{figset7} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.1(): could not find function "{}fig7.1"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in supp7.1(): could not find function "{}supp7.1"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.2(): could not find function "{}fig7.2"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.3(): could not find function "{}fig7.3"{}}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in mtext(side = 3, line = 0.5, "{}A: 1:1 aspect ratio"{}, adj = 0): plot.new has not been called yet}}\begin{alltt}
...
{\ttfamily\noindent\color{warningcolor}{Warning in par(fig = c(0.265, 1, 0, 1), new = TRUE): calling par(new=TRUE) with no plot}}\begin{alltt}
\hlkwd{fig7.3}\hlstd{()}
\end{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in mtext(side = 3, line = 0.5, "{}B: 1:3.5 aspect ratio"{}, adj = 0): plot.new has not been called yet}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in supp7.2(): could not find function "{}supp7.2"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in supp7.3(): could not find function "{}supp7.3"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.6(): could not find function "{}fig7.6"{}}}\end{kframe}
\end{knitrout}
\vspace*{-12pt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.8(): could not find function "{}fig7.8"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.9(): could not find function "{}fig7.9"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.10(): could not find function "{}fig7.10"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.11(): could not find function "{}fig7.11"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.12(): could not find function "{}fig7.12"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.14(): could not find function "{}fig7.14"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.15(): could not find function "{}fig7.15"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.17(): could not find function "{}fig7.17"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.18(): could not find function "{}fig7.18"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in supp7.4(): could not find function "{}supp7.4"{}}}\end{kframe}
\end{knitrout}
\caption{Annual rainfall, from 1901 to 2012, for the Murray-Darling
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in fig7.19(): could not find function "{}fig7.19"{}}}\end{kframe}
\end{knitrout}
