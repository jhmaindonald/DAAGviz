...
\hlkwd{print}\hlstd{(}\hlstr{"Run the separate functions fig8.16A() and fig8.16B()"}\hlstd{)}
\hlstd{\}}
\hlstd{fig8.11A} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- scatter-ni ----}
\hlcom{## Unlogged data}
...
\hlstd{\}}
\hlstd{fig8.11B} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- scatter-logni ----}
...
\hlstd{\}}
\hlstd{fig8.17A} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- bronchitA ----}
\hlcom{## ---- bronchit-ylim ----}
...
\hlstd{\}}
\hlstd{fig8.17B} \hlkwb{<-} \hlkwa{function}\hlstd{()\{}
\hlcom{## ---- bronchitB ----}
\hlcom{## ---- bronchit-ylim ----}
\hlstd{ylim} \hlkwb{<-} \hlkwd{range}\hlstd{(bronchit}\hlopt{$}\hlstd{poll)}\hlopt{+}\hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{2.5}\hlstd{)}
\hlcom{## Panel B}
