...
opts_chunk$set(fig.path='figure/tm-', cache.path='cache/tm-',
...
fig10.1 <- function(){
    cat("\n",
        "Run the separate functions fig10.1A(), fig10.1B() & fig10.1C()",
        "\n")
}
@ %

\begin{figure}
<<wc-10_1x, fig.width=5.75, fig.height=5.75, cache=FALSE, out.width="0.32\\textwidth", top=5, eval=doFigs>>=
fig10.1A()
fig10.1B()
fig10.1C()
@ %
