...
\begin{figure}
<<oz-sites-10_1, fig.width=4, fig.height=6.5, rt=3, warning=FALSE, message=FALSE, out.width="0.6\\textwidth", eval=doFigs>>=
...
For this, access must first be set up to the Google resources that
are required.  See \url{https://github.com/dkahle/ggmap}.

Currently, the development version of {\em ggmap} should be installed,
thus:
<<ggmap-devel>>=
...
\begin{suppfigure}
<<google-possums-10_1, fig.width=5, fig.height=7.5, out.width="0.47\\textwidth", warning=FALSE, message=FALSE, eval=doFigs>>=
supp10.1()
@ %
\end{suppfigure}

<<supp10_2, fig.width=6.5, fig.height=6.5>>=
supp10.2 <- function(){
...
\begin{figure}
<<rlogo-image-10_2, fig.width=3.5, fig.height=3.5, out.width="0.47\\textwidth", eval=doFigs>>=
fig10.2()
@ %
...
\begin{figure}
<<spplot-col3-10_3, fig.width=6, fig.height=2, echo=FALSE, eval=doFigs>>=
fig10.3()
@ %
...
\begin{suppfigure}
<<sp27-10_3, out.width="0.6\\textwidth", eval=doFigs>>=
supp10.3()
@ %
\end{suppfigure}
...
\begin{figure}
<<meuse-bubble-10_4, fig.width=3.75, fig.height=4, out.width="0.47\\textwidth", eval=doFigs>>=
fig10.4()
@ %
