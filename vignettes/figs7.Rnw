...
ggplot2::quickplot(Year, mdbRain, data=DAAG::bomregions2015,
...
\begin{suppfigure}[ht]
<<supp7_2e, fig.width=5, fig.height=5, out.width="0.8\\textwidth">>=
supp7.2()
@ %
...
\begin{figure}[ht]
<<fig7_4e, eval=TRUE, fig.width=3.25, fig.height=3.25, left=1, rt=1, bot=2, top=2, out.width="0.47\\textwidth">>=
fig7.4()
@ %
...
\begin{figure}[ht]
<<fig7_5e, eval=TRUE, fig.width=3.5, fig.height=2.5, bot=1, out.width="0.42\\textwidth">>=
fig7.5()
@ %
\vspace*{-18pt}
...
\begin{figure}[ht]
\vspace*{-6pt}
<<fig7_7e, eval=TRUE, fig.width=3.5, fig.height=3.5, out.width="0.47\\textwidth">>=
fig7.7()
@ %
...
<<fig7_21e, echo=TRUE, eval=doFigs>>=
fig7.21()
@ %

\begin{figure}
<<fig7_21e, echo=FALSE, fig.width=3.25, fig.height=3.25, eval=FALSE, out.width="0.65\\textwidth", warning=FALSE, message=FALSE>>=
@ %
