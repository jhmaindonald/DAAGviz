...
fig5.1 <- function(){
"Run the separate functions fig5.1A() and fig5.1B()."
}
@ %
...
fig5.4 <- function(){
"Run the separate functions fig5.4A() and fig5.4B()."
}
@ %

<<suppfig5_1, eval=TRUE>>=
suppfig5.1 <- function(){
## ---- timevsDist ----
...
fig5.6 <- function(){
  print("Run the separate functions fig5.6A() and fig5.6B()")
}
@ %
...
\begin{figure}
<<fig5_1e, fig.width=4, fig.height=4.5, echo=FALSE, top=2, rt=2, crop=TRUE, out.width="0.47\\textwidth">>=
opar <- par(pty="s")
fig5.1A()
fig5.1B()
par(opar)
...
<<fig5_2e, left=2, fig.width=4.5, fig.height=4.5, out.width="0.97\\textwidth">>=
fig5.2()
@ %
\end{minipage}
...
\begin{figure}
<<fig5_3e, out.width="0.6\\textwidth">>=
fig5.3()
@ %
...
\begin{figure}
<<fig5_4e, out.width="0.47\\textwidth">>=
fig5.4A()
fig5.4B()
@ %
\caption{World record times versus distance, for field and road
...
\begin{suppfigure}
<<suppfig5_1e, out.width="0.47\\textwidth">>=
suppfig5.1()
@ %
...
\begin{figure}
<<fig5_5e, fig.width=3.25, fig.height=3.25, top=2, rt=1.6, out.width="0.47\\textwidth">>=
fig5.5()
@ %
...
\begin{figure}
\vspace*{-6pt}
<<fig5_6e, fig.width=5.25, fig.height=5.25, out.width="0.47\\textwidth">>=
fig5.6A()
fig5.6B()
@ %
...
\begin{figure}
\vspace*{-6pt}
<<fig5_7e, echo=FALSE, fig.width=5, fig.height=2, out.width="0.98\\textwidth">>=
fig5.7()
@ %
...
\begin{figure}
<<fig5_8e, echo=FALSE, fig.width=3.75, fig.height=3.25, rt=2, out.width="0.55\\textwidth">>=
fig5.8()
@ %
...
\begin{figure}
<<fig5_9e, fig.width=5.5, fig.height=3.25, out.width="0.65\\textwidth">>=
fig5.9()
@ %
